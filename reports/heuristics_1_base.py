...
class Heuristics1Base(Heuristics):
    ...
    def _get_results(self) -> list:
        ...
        with open("reports/mainnet/results/receivers_in_skr.json", "w") as file:
            json.dump(result_list, file)

        return result_list

    def _return_stealths(self, statistics) -> set:
        stealths = set(map(lambda v: v["stealth"], statistics))
...
if __name__ == "__main__":
    ...
    h1 = Heuristics1Base(contract_txs, skr_contract_txs)(contract_txs, skr_contract_txs)
    h1.main()